...
class TwoDShape {
    ...
    double area() {
        System.out.println("The area() method should be overridden");
        return 0.0;
    }
}
...
class Test {
    public static void main(String[] args) {
        ...
        TwoDShape[] shapes = {new Triangle(12, 8, "contour"), new Rectangle(10)
                , new Rectangle(10, 4), new Triangle(7), new TwoDShape()
                , new TwoDShape(new Rectangle(4, 2)), new TwoDShape(3, 2, "Rhombus"),};
